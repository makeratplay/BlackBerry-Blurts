...
{
  [ComVisible(true)]
  public class ActionBase : JSONObject, Blurts.Domain.IDisplayItem
  {
    ...
    private static String KEY_IMAGEFILE = "ImageFile";
    ...
    public const int TYPE_DISCONNECT = 11;
    public const int TYPE_CLIPBOARD_PHONE_NUMBER = 17;
    ...
    public ActionBase(String s) : base(s)
    {
      commonInit();
    }

    public ActionBase(DisplayItemType alertType, String alertName)
    {
      try
      {
        commonInit();
